...
class _$_CalendarEvent implements _CalendarEvent {
  ...
  @override
  String toString() {
    return 'CalendarEvent(id: $id, title: $title, description: $description, startDate: $startDate, endDate: $endDate, isAllDay: $isAllDay)';
  }
...
abstract class _CalendarEvent implements CalendarEvent {
  factory _CalendarEvent(
      ...
      required final bool isAllDay}) = _$_CalendarEvent;
